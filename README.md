...
Также можно адаптировать под Яндекс Маркет (не тестировал, но скорее всего можно).
## Стек
1. Python 3.14
...
6. Если захотите обучить модель используйте файл /model/train.ipynb в Google Colab

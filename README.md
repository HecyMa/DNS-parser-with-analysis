...
```
3. Создайте и запустите Docker контейнер с MongoDB для сбора и последующего использования данных (см. mdb_con.py)
4. Далее можно запустить main.py, parser.py или api.py в зависимости от того что вам нужно
